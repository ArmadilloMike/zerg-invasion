   ...
   public static final ItemGroup INFESTED_BLOCK_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(dev.armadilllomike.zerginvasion.block.ModBlocks.SPREADING_BLOCK))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(dev.armadilllomike.zerginvasion.block.ModBlocks.ZERG_INFESTED_LEAVES);
                        entries.add(dev.armadilllomike.zerginvasion.block.ModBlocks.ZERG_INFESTED_STONE);
                        entries.add(dev.armadilllomike.zerginvasion.block.ModBlocks.ZERG_INFESTED_NETHERRACK);
                        entries.add(dev.armadilllomike.zerginvasion.block.ModBlocks.ZERG_INFESTED_END_STONE);
                    }).build());
